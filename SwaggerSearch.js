(function () {
    ...
    function search(param) {
        ...
        if (filtredSwaggerList.length == 0) {
            $("#customModalId").html("<li class=\"list-group-item no-hover\">Sem resultados para \""+param+"\"</li>");
        } else {
